...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-gray-600 bg-white">
      <div className="flex h-16 items-center justify-between px-8">
        {/* Logo */}
        <Link href="/" className="flex items-center space-x-2">
          <Image src={bright_logo || "/placeholder.svg"} alt="bright arc" width={100} height={34} />
        </Link>
                    ...
                    <li className="row-span-3">
                      <NavigationMenuLink asChild>
                        <a
                          ...
                          href="/blogs"
                        >
                          <div className="mb-2 mt-4 text-lg font-medium">Latest Insights</div>
                          <p className="text-sm leading-tight text-muted-foreground">
          ...
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            <SheetContent side="right" className="w-full sm:max-w-sm">
              ...
              <div className="flex flex-col space-y-4">
                ...
                <div className="px-2 py-1">
                  <div className="flex items-center justify-between text-lg font-medium">
                    <Link href="/blogs" className="hover:text-primary-600 transition-colors">
                      Blogs & Insights
                    </Link>
                  </div>
                </div>
